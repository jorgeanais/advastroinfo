...
fold = 0
for train_ix, test_ix in k_fold.split(X_pca, y):
...
cm_df.to_csv("outputs/semisupervised_results/cm_semisupervised.csv")
print(cm_df)
...
plt.tight_layout()
plt.savefig("outputs/semisupervised_results/CM_StratifiedKFold.pdf")
plt.show()

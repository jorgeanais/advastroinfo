...
metrics_df.to_csv("outputs/supervised_results/metrics_StratifiedKFoldz.csv")
print(metrics_df)
...
df.to_csv("outputs/supervised_results/classification_report_supervised_SVM.csv")
...
plt.tight_layout()
plt.savefig("outputs/supervised_results/CM_SVM.png")
plt.show()
